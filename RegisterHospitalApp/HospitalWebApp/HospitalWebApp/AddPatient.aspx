<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPatient.aspx.cs" Inherits="HospitalWebApp.WebForm1" %>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <br />
                    <button type="button" id="save_btn" class="btn btn-primary" runat="server" onserverclick="save_btn_ServerClick">Təsdiqlə</button>
                    
                    <button type="button" id="cancel3" class="btn btn-secondary" runat="server" onserverclick="cancel3_ServerClick">Geri</button> 
